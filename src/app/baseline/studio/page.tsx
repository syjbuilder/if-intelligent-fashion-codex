...
export default function BaselineStudioPage() {
  ...
  return (
    <div className="relative min-h-screen bg-paper">
      ...
      <div key={state.scene} className="scene-in">
        ...
        {state.scene === "results" && (
          <ResultsScene
            onRegenerate={() => dispatch({ type: "generate", prompt: state.prompt })}
            onMoreLike={() => dispatch({ type: "generate", prompt: state.prompt })}
